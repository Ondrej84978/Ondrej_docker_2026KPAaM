...
if __name__=="__main__":
    ...
    A_example = homogenous_transform(R_example, o_example)
    ...
    plot_frame(ax, np.eye(3), np.array([1,0,0]), "World Frame")
    plot_frame(ax, R_example, o_example, "Transformed frame")
